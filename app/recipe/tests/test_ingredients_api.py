...
class PrivateIngredientsAPITests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        """Test that ingredients for auth user are returned"""
    ...
    def test_retrieve_ingredients_assigned_unique(self):
        ...
        ingredient1 = Ingredient.objects.create(name="Raisins", user=self.user)
        ...
        serializer = IngredientSerializer(ingredient1)
